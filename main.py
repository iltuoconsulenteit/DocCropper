...
save_settings = cfg.save_settings
load_license_overrides = cfg.load_license_overrides
save_license_overrides = cfg.save_license_overrides
DEFAULT_DEV_PASSWORD = cfg.DEFAULT_DEV_PASSWORD
DEFAULT_SETTINGS_PASSWORD = cfg.DEFAULT_SETTINGS_PASSWORD
DEMO_FULL_LICENSE_KEY = cfg.DEMO_FULL_LICENSE_KEY
VERSION = cfg.VERSION
VERSION_DATE = cfg.VERSION_DATE
CACHE_BUST = cfg.CACHE_BUST
