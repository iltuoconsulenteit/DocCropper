"""Ensure mobile signing paths are dispatched to FastAPI."""
...
# Stub modules required by platform.config.asgi
...
def test_sign_routes_to_fastapi():
    ...
    asyncio.run(dispatcher({"path": "/sign/test", "method": "GET"}, receive, send))
    assert fastapi_called["path"] == "/sign/test"
