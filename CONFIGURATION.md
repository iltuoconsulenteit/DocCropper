...
- `license_check` – enable remote license validation
- `enable_sign`, `enable_mobilesign`, `enable_removebg`, `enable_compresspdf`, `enable_watermark`
- `crop_dev_only`, `sign_dev_only`, `mobilesign_dev_only`, `removebg_dev_only`, `compresspdf_dev_only`, `watermark_dev_only`, `sponsorframe_dev_only`, `login_dev_only`
