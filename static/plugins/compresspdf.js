export function initPdfCompressPlugin(translations, enabled = false) {
    ...
    controls.style.cssText = 'text-align:left; margin-bottom:8px; font-size:12px;';
    controls.innerHTML = `
      <div>
        <label for="compressionLevel">${translations['compression'] || 'Compression'}</label>
      ...
      <div id="extremeOptions" style="display:none;">
